...
local shellSprites = {{172, 173, 188, 189, 204, 205}, {174, 175, 190, 191, 206, 207}}
...
function Init()
  ...
  DrawText("Sprite Test", 8, 8, DrawMode.TilemapCache, "large")
  DrawText("Position Wrap Test", 8, 6 * 8, DrawMode.TilemapCache, "large")
...
function Draw()
  ...
  -- put together.
  DrawSprite(shellSprites[1][1], 8, 24 - 4, false, false, DrawMode.Sprite, 0)
  DrawSprite(shellSprites[1][2], 18, 24 - 4, false, false, DrawMode.Sprite, 0)
  DrawSprite(shellSprites[1][3], 8, 34 - 4, false, false, DrawMode.Sprite, 0)
  DrawSprite(shellSprites[1][4], 18, 34 - 4, false, false, DrawMode.Sprite, 0)
  DrawSprite(shellSprites[1][5], 8, 34 + 10 - 4, false, false, DrawMode.Sprite, 0)
  DrawSprite(shellSprites[1][6], 18, 34 + 10 - 4, false, false, DrawMode.Sprite, 0)
  ...
  DrawText(string.format("(%04d,%02d)", shellAPos.x, shellAPos.y), shellAPos.x, shellAPos.y + 24, DrawMode.Sprite, "large")
  ...
  DrawText(string.format("(%03d,%04d)", shellBPos.x, shellBPos.y), shellBPos.x, shellBPos.y + 24, DrawMode.Sprite, "large")
