...
function Init()
  ...
  DrawText("CONTROLLER TEST", pos.x, pos.y - 2, DrawMode.Tile, "large", 15)
  ...
  for i = 1, total do
    ...
    DrawText(label1, pos.x, pos.y + i, DrawMode.Tile, "large", 15)
    DrawText(label2, pos.x + pos.xOffset, pos.y + i, DrawMode.Tile, "large", 15)
...
function Draw()
  ...
  for i = 1, totalButtons do
    x = (pos.x + 8) * 8
    y = (( i + pos.y + 2) * 8) + pos.y
    DrawText(player1States[i] == true and "DOWN" or "UP", x, y - 3, DrawMode.Sprite, "large", 14)
  end
  ...
  for i = 1, totalButtons do
    ...
    y = (( i + pos.y + 2) * 8) + pos.y
    DrawText(player2States[i] == true and "DOWN" or "UP", x, y - 3, DrawMode.Sprite, "large", 14)
  end
